...
class VideoViewLayouter {
    ...
    func layoutSessions(sessions: [VideoSession], fullSession: VideoSession?, inContainer container: NSView) {
    ...
    func reponseSessionOfEvent(event: NSEvent, inSessions sessions: [VideoSession], inContainerView container: NSView) -> VideoSession? {
...
private extension VideoViewLayouter {
    func viewListFromSessions(sessions: [VideoSession], maxCount: Int, ignorSession: VideoSession?) -> [NSView] {
        var views = [NSView]()
        for session in sessions {
    ...
    func layoutFullScreenView(view: NSView, inContainerView container: NSView) -> [NSLayoutConstraint] {
    ...
    func layoutSmallViews(smallViews: [NSView], inContainerView container: NSView) -> [NSLayoutConstraint] {
        var layouts = [NSLayoutConstraint]()
        var lastView: NSView?
    ...
    func layoutGridViews(allViews: [NSView], inContainerView container: NSView) -> [NSLayoutConstraint] {
